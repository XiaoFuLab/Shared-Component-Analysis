...
python train.py --data_path $DATADIR --data_name OfficeHome --data_folder_name OfficeHome --source Ar --target Cl --batch_size 64 --workers 4 --lambdaa 1.0 --class_layers 1  --seed 33333\
